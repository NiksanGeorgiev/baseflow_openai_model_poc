...
def add_message_to_thread(thread_id, message):
    ...
    message += """
        ...
        Q: When do I get paid? A: You get paid on the third working day of the month. Note: You are supposed to provide the user with the third workin day of the month.
        """
