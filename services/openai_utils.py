...
def add_message_to_thread(thread_id, message):
    ...
    message += """
        ...
        Q: When do I get paid? A: You get paid on the third working day of the month. /Here put the third working day of the month as a date (e.g 3 Oct 2025). You can look that up online if you are unsure./
        """
